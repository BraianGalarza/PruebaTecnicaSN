  ...
  return (
    <div id='form_tramite_admin'>
      ...
      <div className="mt-6 border-t border-gray-100">
              ...
              <ul role="list" className="divide-y divide-gray-100 rounded-md border border-gray-200">
                <li className="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                  ...
                  <div className="ml-4 flex-shrink-0">
                    {/* <a className="font-medium text-indigo-600 hover:text-indigo-500" onClick={(e) => ({ hanldeDescargar })}>
                      Descargar
                    </a> */}
                    <button onClick={hanldeDescargar} className='font-medium text-indigo-600 hover:text-indigo-500'>Descargar</button>
                  </div>
                </li>
              </ul>
            </dd>
        ...
        <button onClick={handleSubmit} className='relative ml-0 p-2 flex-shrink-0 rounded-full bg-gray-800 p-1 text-white hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800'>Guardar</button>
      </div>
    </div>
    // }
    // </>
